...
function buildBettingBoard() {
	...
	let wl = document.getElementsByClassName('winning_lines')[0];
	...
	let bbtop = document.getElementsByClassName('bbtop')[0];
	...
	let numberBoard = document.getElementsByClassName('number_board')[0];
	...
	let bo3Board = document.getElementsByClassName('bo3_board')[0];
	...
	let otoBoard = document.getElementsByClassName('oto_board')[0];
	...
	let chipDeck = document.getElementsByClassName('chipDeck')[0];
	...
	let bankContainer = document.getElementsByClassName('bankContainer')[0];
	...
	let betSpan = document.getElementById('betSpan');
