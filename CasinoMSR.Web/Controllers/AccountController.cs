...
namespace CustomIdentityApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<User> userManager, GameContext contextApp, SignInManager<User> signInManager, IEmailService emailService)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                User user = new User { Email = model.Email, UserName = model.UserName, ImageName = "Admin", TotalMoney = 100, TotalWon = 0};
