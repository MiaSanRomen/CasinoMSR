...
namespace CasinoMSR.Web.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        //        return NotFound();
        //    }
        //    EditUsernameViewModel model = new EditUsernameViewModel { Id = user.Id, Email = user.Email, UserName = user.UserName };
        //    return View(model);
        //}

        //[HttpPost]
        //public async Task<IActionResult> Edit(EditUsernameViewModel model)
        //{
        //    if (ModelState.IsValid)
        //    {
